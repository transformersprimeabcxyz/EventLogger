...
namespace HashTag.Logging.Connector.MSSQL
{
    public class dbEvent
    {
        ...
        [Column(Order = 1000), Display(Name = "String equivilant of HTTP Status Code to return to client.  See: https://msdn.microsoft.com/en-us/library/system.web.management.webeventcodes%28v=vs.110%29.aspx")]
        public Nullable<int> HttpWebEventValue { get; set; }

        [Column(TypeName = "varchar(max)", Order = 1000), Display(Name = "Numeric value for HTTP Status Code")]
        public Nullable<int> HttpStatusValue { get; set; }

        [MaxLength(50), Column(TypeName = "varchar(max)", Order = 1000), Display(Name = "String equivilant of HTTP Status Code to return to client")]
        public string HttpStatusCode { get; set; }

        [Column(TypeName = "varchar(max)", Order = 1000), Display(Name = "Server side HTML message as generated by .Net application")]
