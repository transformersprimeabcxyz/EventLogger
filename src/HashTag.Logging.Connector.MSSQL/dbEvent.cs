...
namespace HashTag.Logging.Connector.MSSQL
{
    public class dbEvent
    {
        public dbEvent()
        {
            HttpContext = new dbEventHttpContext();
            UserContext = new dbEventUserContext();
        }
        ...
        [Key, Required, StringLength(36), MinLength(36), MaxLength(36), Column(Order = 150, TypeName = "varchar"), Display(Name = "Unique identifier of this instance of an event in the event store")]
        public string UUID { get; set; }

        [MaxLength(200), Column(Order = 160, TypeName = "varchar"), Display(Name = "Name of logger submitting this event.  Some patterns allow for ganular filtering based on logger name")]
