...
namespace HashTag
{
    public static partial class Extensions
    {
        ...
        /// <summary>
        /// (HashTag.Core extension) Binary serialize an object to array of bytes.  This is an extension method so it will work on any object in your code after you have a 
        /// reference to HashTag.Core
        /// </summary>
        ...
        /// <summary>
        /// (HashTag.Core extension) Converts a DateTime to a value that is compatible with SQL Server 2005 and SQL Server 2008
        /// </summary>
        ...
        /// <summary>
        /// (HashTag.Core extension) Add a key,value pair to exception's data collection
        /// </summary>
        ...
        /// <summary>
        /// (HashTag.Core extension) Creates a string of all exception properties
        /// </summary>
        ...
        /// <summary>
        /// (HashTag.Core extension)  Compares two byte arrays for content equality.
        /// </summary>
        /// <param name="sourceBytes">Hydrated non-null byte array for left side of comparison</param>
        /// <param name="targetBytes">Hydrated non-null byte array for right side of comparision</param>
        /// <returns>True if content of two byte arrays are equal</returns>
        public static bool AreEqual(this byte[] sourceBytes, byte[] targetBytes)
        {
            //return sourceBytes.SequenceEqual(targetBytes); //Native .Net
            return Win32Utils.ByteArrayCompare(sourceBytes, targetBytes);  //win32 interop
        }
    }
}