...
namespace HashTag
{
    ...
    {
        public static string ToXmlConfig(this MachineKeySection machineKey)
        {
            return string.Format("<machineKey validationKey=\"{0}\" decryptionKey=\"{1}\" validation=\"{2}\" decryption=\"{3}\"/>",
                machineKey.ValidationKey, machineKey.DecryptionKey, machineKey.Validation.ToString(), machineKey.Decryption);
        }
        ...
        /// <summary>
        /// (HashTag.Core extension) Mask last 4 characters of a string
        /// </summary>
        ...
        /// <summary>
        /// (HashTag.Core extension) Mask last X characters of a string
        /// </summary>
        ...
        /// <summary>
        /// (HashTag.Core extension) Mask the right most X characters of a string with the specified character
        /// </summary>
        ...
        public static string Left(this string target, int characterCount, string suffix)
        {
            ...
            if (target.Length <= characterCount) return target;
...
#endif
        /// <summary>
        /// Creates an indented formated string from non-formatted well-formed xml
        /// </summary>
        /// <param name="doc">Hydrated XML document</param>
        /// <returns>Indented XML with line breaks</returns>
        public static string ToPrettyXml(this XmlDocument doc)
        {
        ...
        /// Creates an indented formated string from non-formatted well-formed xml
        /// </summary>
        /// <param name="uglyXml">Well-formed non-null xml</param>
        /// <returns>Indented XML with line breaks</returns>
        public static string ToPrettyXml(this string uglyXml)
        {
            if (string.IsNullOrEmpty(uglyXml) == true)
            {
                return uglyXml;
            }
            XmlDocument xmlDoc = new XmlDocument();
            xmlDoc.LoadXml(uglyXml);
            return xmlDoc.ToPrettyXml();
        }

        /// <summary>
        /// Detemrines if a number is number by attempting to convert it to a double
        /// </summary>
        /// <param name="numberString"></param>
        /// <returns>True if <paramref name="numberString"/> is a numeric value</returns>
        public static bool IsNumeric(this string numberString)
        {
            double outVal;
            return double.TryParse(numberString, out outVal);
        }

        /// <summary>
        /// Return true if <paramref name="alphaString"/> contains only 0-9 A-Z a-z characters
        /// </summary>
        /// <param name="alphaString"></param>
        /// <returns></returns>
        public static bool IsAlphaNumeric(this string alphaString)
        {
            Regex r = new Regex("^[a-zA-Z0-9]*$");
            return r.IsMatch(alphaString);            
        }

        /// <summary>
        /// Append formated text to string builder
        /// </summary>
        /// <param name="sb"></param>
        /// <param name="text">Text with standard string.format specifiers</param>
        /// <param name="args">Arguments for text</param>
        /// <returns>Reference to <paramref name="sb"/></returns>
        public static StringBuilder  Add(this StringBuilder sb, string text, params object[] args)
        {
