...
namespace HashTag
{
    ...
    public static partial class Serialize
    {
        ...
        public class To
        {
            ...
            /// <summary>
            /// Convert an object into BSON format
            /// </summary>
            /// <param name="obj">Hydrated object to convert</param>
            /// <returns>Binary array of object</returns>
            public static byte[] BSON(object obj)
            {
                using (MemoryStream ms = new MemoryStream())
                { 
            ...
            /// </summary>
            /// <param name="obj">Hydrated object to convert</param>
            /// <returns>Base64 representation of object</returns>
            public static string BSONBase64(object obj)
            {
                return Convert.ToBase64String(BSON(obj));
            }
            ...
            /// <returns></returns>
            public static string JsonDynamic(dynamic obj)
            {
            ...
            /// </summary>
            /// <param name="obj">Non-null object to compress</param>
            /// <returns>Array of compressed bytes</returns>
            public static byte[] Compressed(object obj)
            {
            ...
            public static string CompressedBase64(object obj)
            {
                var bytes = Compressed(obj);
