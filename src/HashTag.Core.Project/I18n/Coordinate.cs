...
namespace HashTag.I18n
{
    ...
    public sealed class Coordinate : IFormattable ,IXmlSerializable 
    {
        ...
        public sealed class Degree : IFormattable,IXmlSerializable 
        {
            ...
            /// <summary>
            /// Default coordinate string �DDD.DDDD
            /// </summary>
            /// <returns>Default formatted string �DDD.DDDD</returns>
            ...
            /// <remarks>
            /// <para>empty, G, D  �DDD.DDDD</para>
            /// <para>DM  �DDDMM.MMMM</para>
            /// <para>DMS,ISO �DDDMMSS.SSSS</para>
            /// <para>d DDD.DDDD� NESW</para>
            /// <para>dm DDD�MM.MMMM NESW</para>
            /// <para>dms DDD�MM'SS.SSSS' NESW</para>
            /// </remarks>
            ...
            /// <summary>
            /// Creates an &lt;coord&gt; element and stores contained value in ISO standard format �DDDMMSS.SSSS
            /// </summary>
    ...
    #region IFormattable Members
        ...
        /// <summary>
        /// Override default behavior and always return �DDDMMSS.SSSS
        /// </summary>
        /// <returns></returns>
        public override string ToString()
        {
        ...
        /// <exception cref="FormatException">Unable to determine the format code to use.</exception>
        /// <remarks>
        /// <para>empty, G, D  �DD.DDDD�DDD.DDDD</para>
        /// <para>A, DA  �DD.DDDD�DDD.DDDD�aaaa</para>
        /// <para>DM   �DDMM.MMMM�DDDMM.MMMM</para>
        /// <para>DMA  �DDMM.MMMM�DDDMM.MMMM�aaaa</para>
        /// <para>DMS  �DDMMSS.SSSS�DDDMMSS.SSSS</para>
        /// <para>DMSA �DDMMSS.SSSS�DDDMMSS.SSSS�aaaa</para>
        /// <para>d  DD.DDDD� W DDD.DDDD� S</para>
        /// <para>dm DD�MM.MMMM E DDD�MM.MMMM W</para>
        /// <para>dms DD�MM'SS.SSSS' W DDD�MM'SS.SSSS' N</para>
        /// </remarks>
        public string ToString(string format, IFormatProvider formatProvider)
        {
...
//DD�MM.MMMM E DDD�MM.MMMM W (26)
//DD�MM'SS.SSSS' W DDD�MM'SS.SSSS' N (36)
