...
namespace HashTag.Reflection
{
    public partial class AssemblyVersion
    {
        ...
        /// that, then all namespaces are included in the stack dump. Excluded namespaces='System','Microsoft','HashTag'
        /// </summary>
        private static string[] _excludedNamespaces = new string[] { "System", "Microsoft", "HashTag", getRootNamespace() }; //EXTENSION
    }
}