...
namespace HashTag.Diagnostics
{
    ...
    public sealed class LogMachineContext 
    {
        ...
        private void getSystemProperties()
        {
            ...
            this.ProcessId = Utils.Win32.GetCurrentProcessId().ToString(NumberFormatInfo.InvariantInfo);
            var currentProc = Process.GetCurrentProcess();
            if (currentProc != null && currentProc.MainModule != null)
            {
                this.ProcessName = currentProc.MainModule.FileName;
            }
            this.Win32ThreadId = Utils.Win32.GetCurrentThreadId().ToString(NumberFormatInfo.InvariantInfo);
