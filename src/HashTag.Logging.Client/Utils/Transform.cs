...
namespace HashTag
{
    ...
    public static partial class Transform
    {
        ...
        public static T ConvertValue<T>(object value)
        {
            ...
            {
                return (T)(object)Enum.Parse(typeof(T), ConvertValue<String>(value), true);
            }
        ...
        {
            return ConvertValue<Int32>(value);
        }
        ...
        {
            return ConvertValue<Int64>(value);
        }
        ...
        {
            return (long)ConvertValue<Int64>(value);
        }
        /// <summary>
        ...
        {
            return (Boolean)ConvertValue<Boolean>(value);         
        }
